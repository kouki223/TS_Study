import { type TAny } from 'jest/node_modules/@sinclair/typebox/build/cjs/type/any';
import { type TArray, type ArrayOptions } from 'jest/node_modules/@sinclair/typebox/build/cjs/type/array';
import { type TBoolean } from 'jest/node_modules/@sinclair/typebox/build/cjs/type/boolean';
import { type TComposite } from 'jest/node_modules/@sinclair/typebox/build/cjs/type/composite';
import { type TConst } from 'jest/node_modules/@sinclair/typebox/build/cjs/type/const';
import { type TEnum, type TEnumKey, type TEnumValue } from 'jest/node_modules/@sinclair/typebox/build/cjs/type/enum';
import { type TExclude, type TExcludeFromMappedResult, type TExcludeFromTemplateLiteral } from 'jest/node_modules/@sinclair/typebox/build/cjs/type/exclude';
import { type TExtends, type TExtendsFromMappedKey, type TExtendsFromMappedResult } from 'jest/node_modules/@sinclair/typebox/build/cjs/type/extends';
import { type TExtract, type TExtractFromMappedResult, type TExtractFromTemplateLiteral } from 'jest/node_modules/@sinclair/typebox/build/cjs/type/extract';
import { TIndex, type TIndexPropertyKeys, type TIndexFromMappedKey, type TIndexFromMappedResult, type TIndexFromComputed } from 'jest/node_modules/@sinclair/typebox/build/cjs/type/indexed';
import { type IntegerOptions, type TInteger } from 'jest/node_modules/@sinclair/typebox/build/cjs/type/integer';
import { Intersect, type IntersectOptions } from 'jest/node_modules/@sinclair/typebox/build/cjs/type/intersect';
import { type TCapitalize, type TUncapitalize, type TLowercase, type TUppercase } from 'jest/node_modules/@sinclair/typebox/build/cjs/type/intrinsic';
import { type TKeyOf } from 'jest/node_modules/@sinclair/typebox/build/cjs/type/keyof';
import { type TLiteral, type TLiteralValue } from 'jest/node_modules/@sinclair/typebox/build/cjs/type/literal';
import { type TMappedFunction, type TMapped, type TMappedResult } from 'jest/node_modules/@sinclair/typebox/build/cjs/type/mapped';
import { type TNever } from 'jest/node_modules/@sinclair/typebox/build/cjs/type/never';
import { type TNot } from 'jest/node_modules/@sinclair/typebox/build/cjs/type/not';
import { type TNull } from 'jest/node_modules/@sinclair/typebox/build/cjs/type/null';
import { type TMappedKey } from 'jest/node_modules/@sinclair/typebox/build/cjs/type/mapped';
import { TModule } from 'jest/node_modules/@sinclair/typebox/build/cjs/type/module';
import { type TNumber, type NumberOptions } from 'jest/node_modules/@sinclair/typebox/build/cjs/type/number';
import { type TObject, type TProperties, type ObjectOptions } from 'jest/node_modules/@sinclair/typebox/build/cjs/type/object';
import { type TOmit } from 'jest/node_modules/@sinclair/typebox/build/cjs/type/omit';
import { type TOptionalWithFlag, type TOptionalFromMappedResult } from 'jest/node_modules/@sinclair/typebox/build/cjs/type/optional';
import { type TPartial, type TPartialFromMappedResult } from 'jest/node_modules/@sinclair/typebox/build/cjs/type/partial';
import { type TPick } from 'jest/node_modules/@sinclair/typebox/build/cjs/type/pick';
import { type TReadonlyWithFlag, type TReadonlyFromMappedResult } from 'jest/node_modules/@sinclair/typebox/build/cjs/type/readonly';
import { type TReadonlyOptional } from 'jest/node_modules/@sinclair/typebox/build/cjs/type/readonly-optional';
import { type TRecordOrObject } from 'jest/node_modules/@sinclair/typebox/build/cjs/type/record';
import { type TRecursive, type TThis } from 'jest/node_modules/@sinclair/typebox/build/cjs/type/recursive';
import { type TRef, type TRefUnsafe } from 'jest/node_modules/@sinclair/typebox/build/cjs/type/ref';
import { type TRequired, type TRequiredFromMappedResult } from 'jest/node_modules/@sinclair/typebox/build/cjs/type/required';
import { type TRest } from 'jest/node_modules/@sinclair/typebox/build/cjs/type/rest';
import { type TSchema, type SchemaOptions } from 'jest/node_modules/@sinclair/typebox/build/cjs/type/schema';
import { type TString, type StringOptions } from 'jest/node_modules/@sinclair/typebox/build/cjs/type/string';
import { type TTemplateLiteral, type TTemplateLiteralKind, type TTemplateLiteralSyntax } from 'jest/node_modules/@sinclair/typebox/build/cjs/type/template-literal';
import { TransformDecodeBuilder } from 'jest/node_modules/@sinclair/typebox/build/cjs/type/transform';
import { type TTuple } from 'jest/node_modules/@sinclair/typebox/build/cjs/type/tuple';
import { Union } from 'jest/node_modules/@sinclair/typebox/build/cjs/type/union';
import { type TUnknown } from 'jest/node_modules/@sinclair/typebox/build/cjs/type/unknown';
import { type TUnsafe, type UnsafeOptions } from 'jest/node_modules/@sinclair/typebox/build/cjs/type/unsafe';
